...
def load_data(pairs, speakers, config):
    ...
    for pair, speaker in product(pairs, speakers):
        gesture_keypoints_path = 'co_speech_gesture_detection/data/videos/npy3/{}_synced_pp{}.npy'.format(pair, speaker)
...
def gendata(all_data, label_path, out_path, history=40, part='train', config='27', save_video=False):
    # history = 40
    time_offset = 2
    num_frames = 18
...
if __name__ == '__main__':
    out_folder = 'co_speech_gesture_detection/data/full_data/'
    history = 40
    ...
    new_gestures_info_path = os.path.join(out_folder, 'gestures_info_mmpose.pkl')
    ...
    out_folder = 'co_speech_gesture_detection/data/data/{}'
    ...
    for fold in unique_folds:
        ...
        for p in ['train', 'test']:
            ...
            gendata(data, label_out_path, data_out_path, part=p, history=history)